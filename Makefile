...
EXTRACT_SRC = extractor_magdeburg.cc osm_types.cc mem_map.cc
...
EXTRACT_OBJ = $(EXTRACT_SRC:.cc=.o) math64.o
...
clean:
	...
	@rm -rf *gcda
	@rm -rf *gcno
	@rm -rf conv_osmxml data_converter simplifier geo_unit_tests make_index extract_md
